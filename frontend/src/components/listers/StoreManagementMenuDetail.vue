<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="StockStatus" v-model="item.stockStatus" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Availability" v-model="item.availability" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
