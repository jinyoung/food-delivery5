<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="FoodSelection" v-model="item.foodSelection" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="EstimatedDeliveryTime" v-model="item.estimatedDeliveryTime" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
