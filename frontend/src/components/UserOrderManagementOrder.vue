<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="음식 선택" v-model="value.foodSelection" :editMode="editMode" :inputUI="''"/>
            ...
            <Money offline label="주문 금액" v-model="value.orderAmount" :editMode="editMode" @change="change"/>
            <String label="주문 상태" v-model="value.orderStatus" :editMode="editMode" :inputUI="''"/>
            <String label="예상 배달 시간" v-model="value.estimatedDeliveryTime" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
